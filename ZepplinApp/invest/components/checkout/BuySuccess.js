  ...
  return (
    <>
      <VStack mb="3" space={4} alignItems="center">
        <Center w="64" h="20" rounded="md"  style={{marginTop: 20}}>
        ...
        <Center w="64" h="20"  rounded="md" >
          {`Congratulations on your ${asset.symbol} purchase!`}
        </Center>
        <Center w="64" h="20"  rounded="md" >
        <Text style={[styles.inActiveText, {fontSize: 14, marginTop: 10, textAlign: 'center'}]}>
        {`You bought ${orderDetails.numberOfShares} share(s) of ${asset.symbol}`}
      </Text>
        </Center>
      </VStack>
