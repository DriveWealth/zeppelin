...
const SEC_CONTEXT = {
  ...
  signature:
    'eyJraWQiOiJhdXRoX3NlY3VyaXR5X2NvbnRleHRfc2lnbl9rZXkiLCJhbGciOiJSUzI1NiJ9.eyJpYXQiOiIxNTcwNDUzNTU2IiwiZXhwIjoiMTU3MDQ4MjM1NiIsInNoYTI1Nl9kaWdlc3QiOiJwNzRsN25PNnExbkZWQ3JyVjNKSk1QdHF0YU5QRkNLMGFkdUNMOXhfY2VvIn0.psOgpg6OAfeO0JLr4CZC3zWaEkDaUWhRbzd4rw2d78NUn-d2GHTj0RSDmb3wh4buceusjuW7_edIodShLXvRXTooIp3nQm4DDlff9zNOEZy9fqukbVScl3pC6lKjPE-d4nZJ3sKgCSA-gBKR95Sr5rqi0qDUltR_zCsWXIrdRvQ',
};
...
const App = ({route, navigation}) => {
  const {fetch: pyplFetch, user} = useContext(DWContext);
